...
$c_Lgameoflife_Serializer$.prototype.init___ = (function() {
  $n_Lgameoflife_Serializer$ = this;
  var this$2 = new $c_sci_StringOps().init___T("\n      |o     oo    oo     oo               ,\n      |      o   ooo    ooo                ,\n      |  oo                                ,\n      |  ooo                               ,\n      |                                    ,\n      |                                    ,\n      |                                    ,\n      |                       oo ooo       ,\n      |                       oooo         ,\n      |o  oo               o               ,\n      |oo ooo                              ,\n      |  oooo                              ,\n      |                                    ,\n      |                                    ,\n    ");
  this.initUniverse$1 = $f_sci_StringLike__stripMargin__C__T(this$2, 124);
  var x1 = this.getSize__T__T2(this.initUniverse$1);
  if ((x1 !== null)) {
    var rows = x1.$$und1$mcI$sp__I();
    var columns = x1.$$und2$mcI$sp__I();
    var jsx$1 = new $c_s_Tuple2$mcII$sp().init___I__I(rows, columns)
  } else {
    var jsx$1;
    throw new $c_s_MatchError().init___O(x1)
  };
  this.x$1$1 = jsx$1;
  this.rows$1 = this.x$1$1.$$und1$mcI$sp__I();
  this.columns$1 = this.x$1$1.$$und2$mcI$sp__I();
  return this
});
...
$c_Lgameoflife_Serializer$.prototype.stationary__p1__T__T__Z = (function(universe1, universe2) {
  return (universe1 === universe2)
});
$c_Lgameoflife_Serializer$.prototype.toString__F1__I__I__T = (function(universe, rows, columns) {
  var isEmpty$4 = (rows <= 0);
  if (isEmpty$4) {
    var scala$collection$immutable$Range$$numRangeElements$4 = 0
  } else {
    var hi = (rows >> 31);
    var scala$collection$immutable$Range$$numRangeElements$4 = (((hi === 0) ? (((-2147483648) ^ rows) > (-1)) : (hi > 0)) ? (-1) : rows)
  };
  ...
  if ((scala$collection$immutable$Range$$numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, rows, 1, false)
  };
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var arg1 = i;
      var this$11 = new $c_sci_Range().init___I__I__I(0, columns, 1);
      var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, universe$3, r) {
        return (function(c$2) {
          var c = $uI(c$2);
          var x1 = $as_Lgameoflife_Liveness(universe$3.apply__O__O(new $c_Lgameoflife_Cell().init___I__I(r, c)));
          var x = $m_Lgameoflife_Alive$();
          if ((x === x1)) {
            return "o"
          } else {
            var x$3 = $m_Lgameoflife_Dead$();
            if ((x$3 === x1)) {
              return " "
            } else {
              throw new $c_s_MatchError().init___O(x1)
      ...
      var elem = $as_sc_TraversableOnce($f_sc_TraversableLike__map__F1__scg_CanBuildFrom__O(this$11, f, bf$1)).mkString__T();
...
$c_Lgameoflife_Serializer$.prototype.main__AT__V = (function(args) {
  var universe = this.fromString__T__F1(this.initUniverse$1);
  this.toHtml__F1__V(universe)
});
$c_Lgameoflife_Serializer$.prototype.gameoflife$Serializer$$$anonfun$toHtml$1__F1__Lorg_scalajs_dom_raw_HTMLCanvasElement__sr_ObjectRef__O = (function(universe$2, canvas$1, varU$1) {
  var u = this.fromString__T__F1($as_T(varU$1.elem$1));
  this.loop__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__F1__I__I__V(canvas$1, u, this.rows$1, this.columns$1);
  var previous = $as_T(varU$1.elem$1);
  varU$1.elem$1 = this.toString__F1__I__I__T($m_Lgameoflife_GameOfLife$().next__F1__F1(u), this.rows$1, this.columns$1);
  if (this.stationary__p1__T__T__Z(previous, $as_T(varU$1.elem$1))) {
    varU$1.elem$1 = this.toString__F1__I__I__T(universe$2, this.rows$1, this.columns$1);
    return (void 0)
  } else {
    return (void 0)
  }
...
$c_Lgameoflife_Serializer$.prototype.fromString__T__F1 = (function(universe) {
  return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, universe$1) {
    return (function(cell$2) {
      var cell = $as_Lgameoflife_Cell(cell$2);
      try {
        var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(universe$1, ",\n", 0);
        var elems$2 = null;
        elems$2 = [];
        var x1 = xs.u.length;
        switch (x1) {
        ...
        while ((i < len)) {
          ...
          var x$3 = $as_T(arg1);
          var this$12 = new $c_sci_StringOps().init___T(x$3);
          var this$13 = $m_sci_List$();
          var cbf = this$13.ReusableCBFInstance$2;
          var jsx$3 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$12, cbf));
          var jsx$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1) {
            return (function(x0$1$2) {
              if ((x0$1$2 === null)) {
                var x0$1 = 0
              } else {
                var this$15 = $as_jl_Character(x0$1$2);
                var x0$1 = this$15.value$1
              };
              switch (x0$1) {
                case 111: {
                  return $m_Lgameoflife_Alive$();
                  break
                }
                default: {
          ...
          var elem = $as_sc_TraversableOnce(jsx$3.map__F1__scg_CanBuildFrom__O(jsx$2, this$16.ReusableCBFInstance$2)).toVector__sci_Vector();
          var unboxedElem = ((elem === null) ? null : elem);
          elems$2.push(unboxedElem);
          i = ((1 + i) | 0)
        };
        var xs$1 = $makeNativeArrayWrapper($d_sci_Vector.getArrayOf(), elems$2);
        $m_sci_Vector$();
        ...
        var jsx$1 = new $c_s_util_Success().init___O($as_Lgameoflife_Liveness($as_sci_Vector($as_sci_Vector(b.result__O()).apply__I__O(cell.x$1)).apply__I__O(cell.y$1)))
      } catch (e) {
      ...
      return $as_Lgameoflife_Liveness(jsx$1.getOrElse__F0__O(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1) {
        return (function() {
          return $m_Lgameoflife_Dead$()
        })
      })($this))))
...
$c_Lgameoflife_Serializer$.prototype.toHtml__F1__V = (function(universe) {
  var canvas = this.init__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement();
  var elem = this.toString__F1__I__I__T(universe, this.rows$1, this.columns$1);
  var varU = new $c_sr_ObjectRef().init___O(elem);
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setInterval((function(universe$2, canvas$1, varU$1) {
    return (function() {
      return $m_Lgameoflife_Serializer$().gameoflife$Serializer$$$anonfun$toHtml$1__F1__Lorg_scalajs_dom_raw_HTMLCanvasElement__sr_ObjectRef__O(universe$2, canvas$1, varU$1)
    })
  })(universe, canvas, varU), 1000.0)
});
$c_Lgameoflife_Serializer$.prototype.getSize__T__T2 = (function(universe) {
  var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(universe, ",\n", 0);
  var elems$2 = null;
  elems$2 = [];
  var x1 = xs.u.length;
  switch (x1) {
  ...
  while ((i < len)) {
    ...
    var elem = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$11, cbf));
    var unboxedElem = ((elem === null) ? null : elem);
    elems$2.push(unboxedElem);
    i = ((1 + i) | 0)
  };
  var u = $makeNativeArrayWrapper($d_sci_List.getArrayOf(), elems$2);
  var this$14 = new $c_scm_ArrayOps$ofRef().init___AO(u);
  var this$15 = $f_sc_TraversableLike__headOption__s_Option(this$14);
  return new $c_s_Tuple2$mcII$sp().init___I__I(u.u.length, $as_sc_LinearSeqOptimized((this$15.isEmpty__Z() ? ($m_sci_List$(), $m_sci_Nil$()) : this$15.get__O())).length__I())
});
...
$c_scm_ArrayOps$ofBoolean.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofByte.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofChar.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofDouble.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofFloat.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofInt.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofLong.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofShort.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
$c_scm_ArrayOps$ofUnit.prototype.mkString__T = (function() {
  return $f_sc_TraversableOnce__mkString__T__T__T__T(this, "", "", "")
});
...
//# sourceMappingURL=craftmanship-fastopt.js.map
